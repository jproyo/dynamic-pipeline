...
--
-- * @filterState ~ Type@: State of the 'StateT' /Monad/ that is the local State of the Filter execution
--
-- * @filterParam ~ Type@: Type of the First Parameter that is pass to the Filter when it is created by the Generator /Anamorphism/. Generator can change the type received from the Reader Channels.
--
...
data UnFoldFilter dpDefinition readElem st filterState filterParam l = 
  UnFoldFilter 
    ...
    , _ufInitState :: readElem -> filterState -- Given the First element in this Filter Instance how to Initiate Internal Filter State (Memory)
