...
runStageWith fn cIns = async (runStage (hUncurry (run fn) cIns) >> closeList cIns)
...
runStageWith' fn cIns cClose = async (runStage (hUncurry (run fn) cIns) >> closeList cClose)
